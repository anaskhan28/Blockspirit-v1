...
const Footer = () =>{
    return (
        ...
        flex-col justify-between items-center my-4 '>
        ...
        <div className='flex justify-center items-center flex-center flex-col mt-5'>
        <p className='text-white text-sm text-center'>Come Join Us</p>
        <p className='text-white text-sm text-center'>info@blockspirit.com</p>
        </div>
        <div className='sm:w-[90%] w-full h-[0.25px] bg-gray-400 mt-5'/>
        <div className='sm-[90%] w-full flex justify-between items-center mt-3'>
        <p className='text-white text-sm text-center'>@blockspirit 2022</p>
